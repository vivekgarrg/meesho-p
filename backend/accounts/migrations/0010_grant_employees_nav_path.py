"""
Grant /employees to already-configured access rules.

Same reasoning as 0005-0008: a rule is an explicit allow-list, so one written
before the Employees tab existed hides it and 403s `employees/`/`owners/`.
"""
