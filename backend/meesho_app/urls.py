...
urlpatterns = [
    ...
    path("bulk-labels/today/reset/", views.label_today_reset,         name="label_today_reset"),
    ...
    path("bulk-listing/flipkart-presets/<int:pk>/",
         bulk_listing_views.bulk_listing_flipkart_preset_detail, name="bulk_listing_flipkart_preset_detail"),
